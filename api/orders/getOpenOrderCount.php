<?php 
    ...
    // $sql = "SELECT COUNT(*) From (Select * From order_items as oi JOIN `cust_payment_details` as cpd ON cpd.order_code=oi.order_code WHERE oi.shopId = '{$shopId}' AND oi.order_status = 0 GROUP BY oi.order_code) As Z";
