<?php 
    ...
    if(isset($EncodedData) && !empty($EncodedData))
    {
        ...
        $hide_0productQty = $DecodedData['hide_0productQty'];
        $vacation_mode = $DecodedData['vacation_mode'];
        if(empty($hide_0productQty))
        {
            if($vacation_mode=='')
            {
                $sql="UPDATE `shop_details` SET `vacation_mode`=0 WHERE `shopId`='{$shopId}' LIMIT 1  ";
        ...
        {
            $sql="UPDATE `shop_details` SET `hide_0productQty`='$hide_0productQty' WHERE `shopId`='{$shopId}' LIMIT 1  ";
