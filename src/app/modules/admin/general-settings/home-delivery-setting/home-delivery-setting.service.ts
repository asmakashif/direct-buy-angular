...
export class HomeDeliverySettingService {
    ...
    getWorkingDays(userId: any) {
        ...
        return this.http.get<ApiResponse>(
            'api/store_setting/getWorkingDays.php',
            { params: params1 }
        );
    }
    getTimeSlots() {
        return this.http.get<ApiResponse>('api/store_setting/getTimeSlots.php');
    }

    getWorkingTime(data: any): Observable<ApiResponse> {
        return this.http.post<ApiResponse>(
            'api/store_setting/getWorkingTime.php',
            data
        );
    }

    // getWorkingTime(user_id: string): Observable<any> {
    //     return this.http.get(
    //         'api/store_setting/getWorkingTime.php?user_id=' + user_id
    //     );
    // }
