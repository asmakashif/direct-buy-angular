...
import { NewRegistrationComponent } from 'app/modules/admin/orders/new-registration/new-registration.component';
//import { projectRoutes } from 'app/modules/admin/dashboards/project/project.routing';

const newRegistrationRoutes: Route[] = [
    {
        path: '',
...
@NgModule({
    ...
    imports: [
        RouterModule.forChild(newRegistrationRoutes),
        MatButtonModule,
